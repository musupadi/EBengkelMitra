package com.destiny.e_bengkelmitra.Model;
...
public class ResponseModel {
    ...
    String nama,gambar;
    String nama_user,nama_belakang,username,password,no_ktp,email,foto;
    String langitude,longitude,nama_depan,no_tlp,foto_bengkel,jenis_jasa,wilayah,rating,alamat;
    String harga_service,kode_pesanan,tanggal_pesanan,jarak,total,username_user,username_mitra;
    String chat,sender;
    ...
    public String getFoto_bengkel() {
        return foto_bengkel;
    }

    public void setFoto_bengkel(String foto_bengkel) {
        this.foto_bengkel = foto_bengkel;
    }
    ...
    public String getUsername_mitra() {
        return username_mitra;
    }

    public void setUsername_mitra(String username_mitra) {
        this.username_mitra = username_mitra;
    }
